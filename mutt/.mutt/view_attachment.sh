...
#
#     Image/JPEG; ~/.mutt/view_attachment %s
#     Image/PNG; ~/.mutt/view_attachment %s
#     Image/GIF; ~/.mutt/view_attachment %s
# 
#     Application/PDF; ~/.mutt/view_attachment %s
#
#         #This HTML example passes the type because file doesn't always work and 
#         #there aren't always extensions.
#
#     text/html; ~/.mutt/view_attachment %s html
#
...
#
#     Application/vnd.ms-excel; ~/.mutt/view_attachment %s "-" '/Applications/OpenOffice.org1.1.2/Start_OpenOffice.org.app'
#     Application/msword; ~/.mutt/view_attachment %s "-" '/Applications/OpenOffice.org1.1.2/Start_OpenOffice.org.app'
# 
#
