...
beautiful.init(home .. "/.config/awesome/themes/default.lua")
...
vicious.register(memwidget, vicious.widgets.mem, "<span color='cyan'> mem:</span> <span color='white'>$1%</span> (<span color='white'>$2MB</span>/$3MB) ", 13)
...
tags = {
    layout = {
        awful.layout.suit.tile.bottom, awful.layout.suit.max, layouts[1], layouts[4], layouts[1],
