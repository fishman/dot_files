...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (dired zoom-frm xkcd-mode tmux spacemacs-whitespace-cleanup spacemacs-theme spacemacs-purpose-popwin spaceline-config pylookup org-expiry org-agenda ob nose mu4e lsp-ui-imenu lsp-imenu java-mode ivy-spacemacs-help info+ image-mode ido-vertical-mode hide-comnt help-fns+ ess-site dos dired-x hybrid-mode holy-mode evil-evilified-state zenburn-theme yasnippet-snippets yapfify winum web-mode w3m vimrc-mode treemacs-projectile toc-org tide sunshine string-inflection sql-indent solarized-theme scimax polymode ess-smart-underscore ess-smart-equals ag ibuffer-projectile ggtags general evil-collection smart-mode-line rainbow-mode pydoc org-edit-latex ov mustache lispy jedi-direx jedi hy-mode helm-projectile helm-bibtex google-this esup elpy elfeed dashboard drag-stuff button-lock beacon org-edna rspec-mode rjsx-mode pyvenv pytest projectile-rails powershell pip-requirements persp-mode pdf-tools paradox pandoc-mode ox-hugo org-web-tools org-mime org-journal org-download org-brain omnisharp ob-restclient mwim mvn meghanada magithub ghub+ lsp-ui lsp-python lsp-java lsp-go live-py-mode kaolin-themes ivy-yasnippet impatient-mode htmlize hl-todo highlight-numbers helm-make gruvbox-theme groovy-mode google-translate go-guru git-timemachine git-link flyspell-correct-ivy flyspell-correct fish-mode evil-surround evil-matchit evil-escape evil-ediff evil-args erlang ein editorconfig dumb-jump doom-modeline eldoc-eval shrink-path darktooth-theme autothemer csharp-mode cquery counsel-projectile company-lsp company-go company-emacs-eclim eclim company-anaconda ccls bbdb base16-theme anaconda-mode aggressive-indent ace-link tern xml-rpc counsel swiper company ess julia-mode highlight iedit ledger-mode smartparens flycheck go-mode helm window-purpose rtags ivy multiple-cursors typescript-mode lsp-mode markdown-mode alert projectile helm-core magit magit-popup git-commit ghub treepy graphql with-editor yasnippet pythonic treemacs pfuture ace-window avy dash which-key use-package hydra org-plus-contrib evil zeal-at-point yaml-mode xwidgete xterm-color xkcd ws-butler wgrep websocket web-beautify volatile-highlights vmd-mode vi-tilde-fringe vagrant-tramp vagrant uuidgen unfill undo-tree treemacs-evil tldr tagedit tablist systemd symon spray spinner spaceline-all-the-icons smyx-theme smex smeargle slim-mode simple-mpc shut-up shell-pop seeing-is-believing scss-mode sass-mode rvm ruby-tools ruby-test-mode ruby-refactor ruby-hash-syntax rubocop robe restart-emacs rbenv ranger rake rainbow-delimiters pyenv-mode py-isort pug-mode protobuf-mode prettier-js popwin pony-mode plantuml-mode pippel pipenv phpunit phpcbf php-extras php-auto-yasnippets password-generator parent-mode ox-twbs ox-reveal ox-pandoc ox-ioslide ox-gfm ox-asciidoc overseer orgit org-wiki org-protocol-capture-html org-projectile org-present org-pomodoro org-drill-table org-caldav org-bullets org-alert open-junk-file ob-ipython ob-http ob-elixir nginx-mode nameless multi-term mu4e-maildirs-extension mu4e-alert move-text monokai-theme mmm-mode minitest maven-test-mode markdown-toc magit-svn magit-gitflow magit-gh-pulls macrostep lsp-javascript-typescript lorem-ipsum log4e livid-mode link-hint langtool json-navigator json-mode js2-refactor js-doc jinja2-mode ivy-xref ivy-rtags ivy-purpose ivy-hydra insert-shebang inflections indent-guide importmagic imenu-list hungry-delete hlint-refactor hindent highlight-parentheses highlight-indentation helm-youtube haskell-snippets groovy-imports gradle-mode goto-chg google-c-style golden-ratio godoctor go-tag go-rename go-impl go-gen-test go-fill-struct go-eldoc gnuplot gntp gitignore-templates gitignore-mode github-search github-clone gitconfig-mode gitattributes-mode git-messenger git-gutter-fringe git-gutter-fringe+ gist gh-md fuzzy font-lock+ focus flyspell-popup flycheck-mix flycheck-credo flycheck-bashate flx-ido fill-column-indicator feature-mode fasd fancy-battery eyebrowse expand-region evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-snipe evil-replace-with-register evil-org evil-numbers evil-magit evil-lisp-state evil-lion evil-ledger evil-indent-plus evil-iedit-state evil-goggles evil-exchange evil-commentary evil-cleverparens evil-anzu eval-sexp-fu esxml ess-R-data-view eshell-z eshell-prompt-extras esh-help ensime emmet-mode elisp-slime-nav drupal-mode dotenv-mode disaster diminish diff-hl define-word dante dactyl-mode cython-mode csv-mode counsel-dash counsel-css confluence company-ycmd company-web company-terraform company-tern company-statistics company-shell company-rtags company-restclient company-quickhelp company-php company-lua company-ghci company-ghc company-cabal company-c-headers company-ansible column-enforce-mode cmm-mode clean-aindent-mode clang-format chruby centered-cursor-mode bundler browse-at-remote bind-key auto-yasnippet auto-highlight-symbol auto-dictionary auto-compile async apiwrap ansible-doc ansible alchemist adoc-mode ac-ispell))))
(custom-set-faces
